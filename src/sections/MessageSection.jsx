...
const MessageSection = () => {
  ...
  useGSAP(() => {
    ...
    const pharagraphMsgSplit = SplitText.create(".message-content p", {
        type: "words, lines",
        linesClass: "pharagraph-line",
    });
    ...
    paragraphTl.from(pharagraphMsgSplit.words, {
      yPercent: 300,
      rotate: 3,
      ease: "power1.inOut",
      duration: 1,
        ...
        <div className='container mx-auto flex-center py-28 relative'>
            <div className='w-full h-full'>
                ...
                <div className='flex-center md:mt-20 mt-10'>
                    <div className='max-w-md px-5 flex-center overflow-hidden'>
                        <p>
